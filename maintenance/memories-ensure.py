...
def main() -> int:
    ...
    year_rows = db_query(
        ...
        "and lower(coalesce(a.\"originalFileName\", '')) not like 'screenshot%' "
        "and lower(coalesce(a.\"originalFileName\", '')) not like 'screen recording%' "
        "and lower(coalesce(a.\"originalFileName\", '')) not like '%screen_shot%' "
        "and lower(coalesce(a.\"originalFileName\", '')) not like '%screen-shot%' "
        "and lower(coalesce(a.\"originalFileName\", '')) not like '%captura de pantalla%' "
        "and lower(coalesce(a.\"originalFileName\", '')) not like '%screencap%' "
