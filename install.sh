...
ASSET_CACHE_TTL_SEC=${ASSET_CACHE_TTL_SEC:-90}
ASSET_CACHE_MAX=${ASSET_CACHE_MAX:-2048}
CACHE_VIDEOS_CANONICAL_MODE=${CACHE_VIDEOS_CANONICAL_MODE:-prefer}
CACHE_VIDEOS_LEGACY_FALLBACK_LOG_EVERY=${CACHE_VIDEOS_LEGACY_FALLBACK_LOG_EVERY:-100}
...
VIDEO_REPROCESS_BATCH_LIGHT=${VIDEO_REPROCESS_BATCH_LIGHT:-20}
VIDEO_REPROCESS_BATCH_HEAVY=${VIDEO_REPROCESS_BATCH_HEAVY:-3}
...
VIDEO_AUTOPILOT_SLICE_MIN=${VIDEO_AUTOPILOT_SLICE_MIN:-6}
...
*/20 * * * * /usr/local/bin/video-autopilot.sh
